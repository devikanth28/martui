      ...
      >
        ...
        >
          ...
          {prevSrc && (
              ...
              <a class="next-previous-icon-bg carousel-control-prev ml-3"  onClick={!this.isAnimating() ? this.requestMovePrev : undefined} aria-label={this.props.prevLabel}
          ...
          {nextSrc && (
              <a class="next-previous-icon-bg carousel-control-next mr-3 "aria-label={this.props.nextLabel}  onClick={!this.isAnimating() ? this.requestMoveNext : undefined} role="button" tabindex="0"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a>
          )}
