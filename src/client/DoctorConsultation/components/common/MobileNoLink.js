...
const MobileNoLink =(props)=>{
    return (<a role="link" className={props.className} href={`tel:${props.mobileNo}`} title="Click to Call">
        <PhoneSvg/>
        {props.mobileNo}
    </a>)
}
const PhoneSvg =()=>{
    return (<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" className="mr-2">
