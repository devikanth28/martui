...
const PharmacyProductSearchResultGhostImage = () => {
  return (
    <React.Fragment>
      <div className="m-0 my-3 p-0 ph-item ph-row bg-none">
        <div className="m-0 ph-col-2 rounded-xl" style={{"height":"1.5rem"}}></div>
      </div>
        <div className='row'>
          <div className='col-8'>
...
export default PharmacyProductSearchResultGhostImage;