...
import ProductOffersPlaceholder from './ProductDetailPagePlaceholders/ProductOffersPlaceholder'
const ProductOffers = () => {
  return (
    <React.Fragment>
    <div>
        <div className="row ml-0 mr-0 mb-2">
            ...
            <div className="col-10 text-center">
                ...
                <div className="col-12 p-0 text-center">
                    <a href="/safeAndSecure" class="color-Dorange font-14 strong">Genuine Products
                        <span class="mx-1">|</span>Secure Payments</a>
                </div>
            </div>
        </div>
    </div>
    <ProductOffersPlaceholder/>
</React.Fragment>
  )
}
