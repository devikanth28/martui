...
import RefillIntervalIcn from "../../../images/common/refil-interval-icn.svg";
...
const Refill = (props) => {
    ...
    return (
    <React.Fragment>
       <section className="additional-details-section body-height-single-nav-no-footer">
            <h3 className="section-title">
                <small>Sign Up for</small>
                <strong> Easy Refill</strong> 
            </h3>	
            <p>We will repeat the order as per your selected delivery interval. You can always modify your refill request under MY REFILLS section in your account</p>
            <div>
                <h6>How it works?</h6>
                <ol>
                    <li>
            ...
            <div>
                <h6 className="green-heading-label">Select Delivery Interval</h6>
                <div className="refill-interval mb-4">		
                    <div className={`custom-control custom-radio ${props.refillInterval == "30" ? "border" : ""}`} onClick={() => {props.selectRefillInterval("30")}}>
                        <input type="radio" className="custom-control-input" id="30-days-interval" name="interval-select"/>
                        <label className="custom-control-label" for="30-days-interval">I want to repeat every 30 days</label>
                        <p style={{display : props.refillInterval == "30" ? "block" : "none"}}>
                            <small>Your next order will be processed <span>30 days</span> from Today</small>
                        </p>
                    </div>
                    <div className={`custom-control custom-radio ${props.refillInterval == "45" ? "border" : ""}`} onClick={() => {props.selectRefillInterval("45")}}>
                        <input type="radio" className="custom-control-input" id="45-days-interval" name="interval-select"/>
                        <label className="custom-control-label" for="45-days-interval">I want to repeat every 45 days</label>
                        <p style={{display : props.refillInterval == "45" ? "block" : "none"}}>
                            <small>Your next order will be processed <span>45 days</span> from Today</small>
                        </p>
                    </div>
                    <div className={`custom-control custom-radio ${props.refillInterval == "60" ? "border" : ""}`} onClick={() =>  {props.selectRefillInterval("60")}}>
                        <input type="radio" className="custom-control-input" id="60-days-interval" name="interval-select"/>
                        <label className="custom-control-label" for="60-days-interval">I want to repeat every 60 days</label>
                        <p style={{display : props.refillInterval == "60" ? "block" : "none"}}>
                            <small>Your next order will be processed <span>60 days</span> from Today</small>
                        </p>
                    </div>	
                </div>
                        ...
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="36.501" height="36.5" viewBox="0 0 36.501 36.5">
                                <g transform="translate(-1633.283 -583.717)">
                                    <rect fill="none" width="36" height="36" transform="translate(1633.283 584.217)"/>
                                    <path fill="#08ce73" d="M1642.373,606.217a8.97,8.97,0,1,0,8.97,8.97A8.97,8.97,0,0,0,1642.373,606.217Zm0,16.744a7.774,7.774,0,1,1,7.774-7.774A7.774,7.774,0,0,1,1642.373,622.961Z" transform="translate(0 -4.06)"/>
                                    <path fill="#e71c37" d="M-9981.707-3052.564l-3.216-2.572v-3.875a.6.6,0,0,1,.6-.6.6.6,0,0,1,.6.6v3.3l2.768,2.213a.6.6,0,0,1,.093.84.6.6,0,0,1-.467.225A.591.591,0,0,1-9981.707-3052.564Zm-4.411-13.023a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h3.586a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Z" transform="translate(11626.697 3666.548)"/>
                                    <g transform="translate(1636.991 584.217)">
                                        <path fill="#404040" stroke="rgba(0,0,0,0)" d="M-11607.562-3619.906a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h13.4a1.553,1.553,0,0,0,1.546-1.555v-16.981h-3.588a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h3.588v-4.425a1.554,1.554,0,0,0-1.546-1.555h-3.238v1.2a2.392,2.392,0,0,1-2.393,2.392h-.6a2.391,2.391,0,0,1-2.392-2.392v-.9h-9.568v.9a2.392,2.392,0,0,1-2.393,2.392h-.6a2.392,2.392,0,0,1-2.393-2.392v-1.2h-3.237a1.555,1.555,0,0,0-1.547,1.555v4.425h22.127a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6h-22.127v5.245a.6.6,0,0,1-.6.6.6.6,0,0,1-.6-.6v-10.866a2.75,2.75,0,0,1,2.742-2.751h3.237v-.6a2.392,2.392,0,0,1,2.393-2.392h.6a2.392,2.392,0,0,1,2.393,2.392v.9h9.568v-.9a2.391,2.391,0,0,1,2.392-2.392h.6a2.392,2.392,0,0,1,2.393,2.392v.6h3.238a2.751,2.751,0,0,1,2.742,2.751v22.6a2.75,2.75,0,0,1-2.742,2.751Zm5.979-28.7v2.99a1.2,1.2,0,0,0,1.2,1.2h.6a1.2,1.2,0,0,0,1.2-1.2v-2.99a1.2,1.2,0,0,0-1.2-1.2h-.6A1.194,1.194,0,0,0-11601.582-3648.608Zm-14.95,0v2.99a1.2,1.2,0,0,0,1.2,1.2h.6a1.2,1.2,0,0,0,1.2-1.2v-2.99a1.194,1.194,0,0,0-1.2-1.2h-.6A1.2,1.2,0,0,0-11616.532-3648.608Zm16.719,22.757a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.405a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.4a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm4.2-2.8a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.405a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.605.605,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.4a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.408a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm8.4-2.8a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.405a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.6.6,0,0,1-.6-.6.605.605,0,0,1,.6-.6h1.4a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.408a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm8.4-2.8a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.405a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.4a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Zm-4.2,0a.6.6,0,0,1-.6-.6.6.6,0,0,1,.6-.6h1.408a.6.6,0,0,1,.6.6.6.6,0,0,1-.6.6Z" transform="translate(11623.708 3651)"/>
                                    </g>
                                </g>
                            </svg>
                        </span>
...
export const  RefillSuccessModel  = (props) => { 
    return (
        <React.Fragment>
            <Modal className="modal-dialog-centered refill-interval-popup" backdrop="static" keyboard={false} isOpen={props.toggleModel} toggle={props.toggleRefillModel} style={{paddingRight: "15px"}}>
                <ModalBody className="modal-body">
                    <img srcSet={RefillIntervalIcn}/>
                    <h5>Refill service set successfully</h5>
                    <h6>We will repeat your order every {props.refillInterval} days and you will soon receive an sms and email with details of order.</h6>
                    <div className='d-flex'>
                        <button type="button" className="btn brand-secondary px-4 rounded-pill custom-btn-lg" value="Go To Home" onClick={event => window.location.href = CONFIG.REDIRECT_HOME_URL}>Go To Home</button>
                        <button className="btn  btn-brand-gradient ml-3 px-5 rounded-pill custom-btn-lg" type="button" value="GO TO MY REFILLS" onClick={event => window.location.href = CONFIG.REDIRECT_HOME_URL + "myRefills"} >Go To My Refills</button>
                    </div>
                </ModalBody>
            </Modal>    
