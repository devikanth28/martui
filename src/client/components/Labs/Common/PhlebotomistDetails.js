...
const PhlebotomistDetails = (props)=>{
        ...
        <React.Fragment>
            <span className="small font-weight-bold">Phelbotomist Details</span>
                ...
                <p className="d-block font-weight-normal">
                    ...
                    <a className="text-primary font-weight-bold" href="tel:7660027012" title="Click to Call">7660027012</a>
                </p>
        </React.Fragment>
    )
}

export default PhlebotomistDetails;