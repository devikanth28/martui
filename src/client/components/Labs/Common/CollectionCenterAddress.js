...
const CollectionCenterAddress = (props)=>{

    return(
        <React.Fragment>
            <span className="small font-weight-bold">Collection Center Address</span>
            <p className="font-weight-bold mt-2">GACHIBOWLI LAB CS</p>
            <address class="no-select p-0">
                <small class="d-flex">Sh.No.384, H.No.1-73/8, Gachibowli</small>
                <p class="d-block mt-3">
                    ...
                    <a class="text-primary" href="tel:9398666000" title="Click to Call">9398666000</a>
...
export default CollectionCenterAddress;