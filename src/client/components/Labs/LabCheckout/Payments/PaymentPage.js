...
const PaymentPage = (props)=>{
    ...
    const [alertInfo, setAlertInfo] = useState(validate.isNotEmpty(response_message)?{ message:params.RESPONSE_MESSAGE, type: "" }:{});
    ...
    const handlePaymentSubmit = (dataObj) => {
        ...
        // const userContactDetails = dataObj.userContactDetails;
        ...
        var pincode = { "name": "pincode", "value": userInfo.shippingAddress.pincode };
        inputArray.push(pincode);

        var state = { "name": "state", "value": userInfo.shippingAddress.state };
        inputArray.push(state);

        var city = { "name": "city", "value": userInfo.shippingAddress.city };
        inputArray.push(city);

        var country = { "name": "country", "value": "IND" };
        inputArray.push(country);

        var address = { "name": "address", "value": userInfo.shippingAddress.address };
                        ...
                        <section>
                            ...
                            <div className="payment-options pt-2">
                                ...
                                {paymentConfigData.codPaymentAllowed && paymentConfigData.codPaymentAllowed==='Y' &&
                                    ...
                                    mode={{'displayName':'Now you can pay with cash on delivery. No online/UPI payment will be accepted on delivery.'}} selectedDiscount={selectedDiscount}/>
                                }
                                </ul>
                            </div>
                        </section>
                    ...
                    <div className="row align-items-center no-gutters">
                        <div className="col-12 text-right">
                            <React.Fragment>
                                ...
                                <button type="submit" className="btn btn-outline-brand px-5 ml-3 rounded-pill" data-toggle="modal" data-target=".refill-interval-popup" onClick={redirectToHome}>
                                    add more tests
                                </button>
                            </React.Fragment>
                        </div>
