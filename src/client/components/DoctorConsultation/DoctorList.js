                ...
                return(
                    <React.Fragment>
                        <div className="each-doctor-card">
                            <DoctorCard history={props.history}/> 
                        </div>
                    </React.Fragment>
    ...
    return (
        <React.Fragment>
                <section className="shadow-none">
                    <div className="category-container pb-3">
                    <h5 className="mt-0 mb-3"> {props.title}</h5>
                        ...
                        {/* <div className="selected-filter-container">
                            <div className="each-filter">
                                ...
                                <button className="filter-remove-btn" role="button" title='Remove Cardiology'>
                        ...
                        <button className="btn brand-secondary px-5 mt-5">Load More (18 Doctors)</button>
                    </div>
                </section>
