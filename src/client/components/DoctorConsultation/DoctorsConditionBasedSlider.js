...
const DoctorsConditionBasedSlider = (props) => {
    const settings = {
        dots: false,
        infinite: false,
        speed: 500,
        ...
        slidesToShow: props.isOnline ? 11 : 7,
        //slidesToShow: 10,
        responsive: [
            {
                breakpoint: 1440,
        ...
        return (
            <Slider className="condition-based-test-slider custom-slide-arrows inner-arrows" {...settings}>
                {conditionBasedTestJson.map((each) => {
                    return (
                        <div className="item">
                            <a href="/doctorSpecialization" title={each.title}>
    ...
    return (
        <React.Fragment>
            <div className="d-flex align-items-center justify-content-between align-items-center mb-3">
                ...
                {props.showViewAll && <button className="btn brand-secondary rounded-pill px-4" onClick={()=>{window.location.href = "/symptomsViewAllPage";}} type="button">view All</button> }
            </div>
            <section className="shadow-none" style={{"height" : "calc(100% - 51px)"}}>
                <div className="h-100 d-flex align-items-center">
                    <div className="w-100 home-page-slider-container condition-based-test-slider mb-0 py-0">
            ...
            <div className="home-page-slider-container condition-based-test-slider pt-2 d-flex justify-content-around">
                    <div className="item">
                            <a>
                                <div className="card border-0">
                                    <div class="card-body p-2">
...
export default DoctorsConditionBasedSlider;