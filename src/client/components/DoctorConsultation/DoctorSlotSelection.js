...
function DoctorSlotSelection(props) {
    const settings = {
        dots: false,
        infinite: false,
        speed: 500,
            ...
            <div className="container-lg container-fluid">
                <div className="row px-sm-3">
                    <div className="col-8 pl-0 pr-2">
                        <DoctorReviewDetail walkIn={true}/>
                        <section>
                            <div className="header"><p>Select a time slot</p></div>
                            <div className="row add-patient-section m-0 px-2">
                ...
                <div class="container-lg container-fluid  px-0 px-sm-3">
                    <div class="row align-items-center no-gutters">
                        <div class="col-12 text-right">
                            <button type="button" class="btn brand-secondary px-5 rounded-pill">Back</button>
                            <button type="submit" class="btn btn-brand-gradient ml-3 px-5 rounded-pill">Confirm & Proceed</button>
                        </div>
                    </div>
                </div>
            </footer>
