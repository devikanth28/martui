...
function KYMHeader(props) {
    return (
        <React.Fragment>
            <div className="kym-header kym-1024 row no-gutters main-header fixed-top">
                <div className='col-3 d-flex align-items-center'>
                    <a class="back-icn me-3" href="javascript:void(0);" title="Back" onClick={() => props.history.goBack()}>
                ...
                <div className="col-7 d-flex justify-content-center kym-global-search">
                    <ProductSearch history={props.history} isKym={true}></ProductSearch>
                </div>
            </div>
