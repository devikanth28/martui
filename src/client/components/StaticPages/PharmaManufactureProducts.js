...
const PharmaManufactureProducts = () => {
  return (

    <React.Fragment>
        <TabPane className='alphabetwise-products-list'>
          <div className=''>
        ...
        <div className='Alphabet p-2'>
                ...
                <div className="each-section">
                  <h6 className="each-section-title">
                    <span>0-9</span>
                  </h6>
                  <ul>
                    <li>
                      <a href="/manufacturer/3M" title="3M">
                    ...
                    <li>
                      <a href="/manufacturer/3M" title="3M INDIA">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                          <g transform="translate(-906.838 780) rotate(-90)">
                              <rect fill="none" width="18" height="18" transform="translate(762 906.838)"/>
                              <path fill="#080808" d="M61.559,501.985l4.049-4.049a.917.917,0,1,0-1.3-1.3l-3.4,3.39-3.4-3.4a.921.921,0,0,0-1.569.649.912.912,0,0,0,.272.649l4.049,4.059A.922.922,0,0,0,61.559,501.985Z" transform="translate(710.032 416.557)"/>
                    ...
                    <li>
                      <a href="/manufacturer/3M" title="4 CARE LIFE SCIENCES">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                          <g transform="translate(-906.838 780) rotate(-90)">
                              <rect fill="none" width="18" height="18" transform="translate(762 906.838)"/>
                              <path fill="#080808" d="M61.559,501.985l4.049-4.049a.917.917,0,1,0-1.3-1.3l-3.4,3.39-3.4-3.4a.921.921,0,0,0-1.569.649.912.912,0,0,0,.272.649l4.049,4.059A.922.922,0,0,0,61.559,501.985Z" transform="translate(710.032 416.557)"/>
                        ...
                        4 CARE LIFE SCIENCES
                      </a>
                    </li>
                    <li>
                      <a href="/manufacturer/3M" title="6TH SKIN PHARMA">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                          <g transform="translate(-906.838 780) rotate(-90)">
                              <rect fill="none" width="18" height="18" transform="translate(762 906.838)"/>
                              <path fill="#080808" d="M61.559,501.985l4.049-4.049a.917.917,0,1,0-1.3-1.3l-3.4,3.39-3.4-3.4a.921.921,0,0,0-1.569.649.912.912,0,0,0,.272.649l4.049,4.059A.922.922,0,0,0,61.559,501.985Z" transform="translate(710.032 416.557)"/>
...
export default PharmaManufactureProducts