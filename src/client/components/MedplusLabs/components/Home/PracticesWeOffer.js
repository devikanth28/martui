                    ...
                    <section className="bg-transparent shadow-none">
                        <div className="mb-4 pb-2 practises-div">
                            ...
                            <div className="align-items-start d-flex">
                                <span>
                                    <span className="img-container">
                                        <img src={CompititivePrice} alt="Competitive Price" title="Competative Price"/>
                                    </span>
                                </span>
                                <div className="pl-3">
                                    <h6 className="mb-2">Competative Price</h6>
                                    <p className="mb-0">We offer best prices on our diagnostic test and health packages
                                    </p>
                                </div>
                            </div> 
                        </div>
