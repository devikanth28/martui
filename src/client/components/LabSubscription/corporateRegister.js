...
export const truncate = (name,length) => {
    let ext = name.substring(name.lastIndexOf('.') + 1, name.length).toLowerCase()
    let newName = name.replace('.' + ext, '');
    if (name.length <= length) {
        return name;
      }
      newName = newName.substring(0, length) + (name.length > length ? '...' : '');
      return newName + '.' + ext;
}

const LabSubscriptionCorporateRegister = () => {
    ...
    const handleChange=(e) => {        
        ...
        if (fieldName == 'photoIdNumber'){
            return 
        }
        else if (fieldName == 'addMore') {
            setaddmore(true)
        }
        else {
            ...
            <div className="subs-login-container">
                <section className="subs-login">
                    <div className="content">
                        <h4 className="mb-3">Corporate Register</h4>
                       ...
                       <div className="form-group has-float-label mb-3">
                        ...
                        <div className="col pl-1 pr-0"><button class="btn  btn-brand btn-block"> Register</button></div> 
                            <div className="col-6 pr-1 pl-0"><button class="btn  btn-light  btn-block"> Cancel</button></div> 
...
export default LabSubscriptionCorporateRegister;